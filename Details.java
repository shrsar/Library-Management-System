...
public class Details extends javax.swing.JFrame {
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        String query="SELECT * FROM USERS WHERE UID='"+inp+"';";
        try{
            ...
            while(rs.next()){
                ...
                model.addRow(new Object[] {uid, name, num, fine});
            }
            rs.close();
            stm.close();
        }
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
        ...
        String mysqlpwd="1234";
        String inp=t1.getText();
        String query="SELECT * FROM DUES WHERE UID='"+inp+"';";
        try{
            Connection conn=DriverManager.getConnection(url, mysqlusr, mysqlpwd);
            Statement stm=conn.createStatement();
            ResultSet rs=stm.executeQuery(query);
            while(rs.next()){
                ...
                String isd=rs.getString("ISD");
                String rsd=rs.getString("RTD");
                String rts=rs.getString("RTS");
                model.addRow(new Object[] {uid, bid, isd, rsd, rts});
            }
            rs.close();
            stm.close();
        }
